    ...
    return (
        <form action={formAction} className="p-5 lg:p-6 bg-white rounded-2xl shadow-xl border border-slate-100 relative transition-all duration-500">
            ...
            <div className={`transition-all duration-500 ${step === 1 ? 'opacity-100' : 'opacity-0 hidden'}`}>
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-slate-200 relative z-20 flex flex-col md:block">

                    {/* --- ROW 1 (From/To) --- */}
                    <div className="flex flex-col md:flex-row border-b border-slate-100">

                        {/* 1. FROM (50%) */}
                        <div className="w-full md:w-1/2 relative group p-4 first:rounded-t-2xl md:first:rounded-none md:rounded-tl-2xl hover:bg-slate-50 transition-colors border-b md:border-b-0 md:border-r border-slate-100" ref={fromRef}>
                            ...
                            {/* Suggestions */}
                            {showFromSuggestions && (
                                <div className="absolute top-[100%] left-0 w-full min-w-[300px] bg-white shadow-2xl rounded-xl border border-slate-100 mt-2 z-50 overflow-hidden animate-in fade-in slide-in-from-top-2">
                        ...
                        {/* 2. TO (50%) */}
                        <div className="w-full md:w-1/2 relative group p-4 md:rounded-tr-2xl hover:bg-slate-50 transition-colors" ref={toRef}>
                            <label className="flex items-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">
                    ...
                    {/* --- ROW 2 (Dates/Pax/Search) --- */}
                    <div className="flex flex-col md:flex-row">

                        {/* 3. DEPART (25%) */}
                        <div className="w-full md:w-[25%] relative group p-4 md:rounded-bl-2xl hover:bg-slate-50 transition-colors border-b md:border-b-0 md:border-r border-slate-100 cursor-pointer" ref={departRef} onClick={() => setShowDepartCalendar(!showDepartCalendar)}>
                            <label className="flex items-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">
                                <CalendarDays className="w-3.5 h-3.5" /> Depart
                            </label>
                            <div className={`text-lg font-bold truncate font-mono ${flightForm.date ? "text-slate-900" : "text-slate-300"}`}>
                        ...
                        {/* 4. RETURN (25%) */}
                        <div className="w-full md:w-[25%] relative group p-4 transition-colors border-b md:border-b-0 md:border-r border-slate-100 cursor-pointer hover:bg-slate-50"
                            ref={returnRef}
                        ...
                        >
                            ...
                            <div className="flex items-center justify-between">
                                <div className={`text-lg font-bold truncate font-mono ${flightForm.return_date ? "text-slate-900" : "text-slate-300"}`}>
                        ...
                        {/* 5. TRAVELLERS (25%) */}
                        <div className="w-full md:w-[25%] relative group p-4 hover:bg-slate-50 transition-colors border-b md:border-b-0 md:border-r border-slate-100 cursor-pointer" ref={travellersRef} onClick={() => setShowTravellers(!showTravellers)}>
                            <label className="flex items-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1">
                            ...
                            {showTravellers && (
                                <div className="absolute top-[100%] right-0 w-[280px] bg-white shadow-2xl rounded-xl border border-slate-100 p-5 z-50 mt-2 cursor-default animate-in fade-in slide-in-from-top-2">
                        ...
                        {/* 6. SEARCH BUTTON (25%) */}
                        <div className="w-full md:w-[25%] p-2 md:rounded-br-2xl">
                            <button
                                type="button"
