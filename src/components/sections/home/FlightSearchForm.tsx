                ...
                <div className="grid grid-cols-2 md:flex md:flex-row items-center bg-white md:rounded-full rounded-2xl shadow-xl relative z-20 md:p-2 md:pl-4 bg-opacity-95 backdrop-blur-sm border border-white/20">
                    ...
                    <div className="md:w-auto md:flex-[1.5] relative group p-4 border-r border-b md:border-0 border-slate-100 md:hover:bg-slate-50 md:rounded-full transition-colors rounded-tl-2xl md:rounded-tl-none" ref={fromRef}>
                        ...
                        <input
                            ...
                            className="w-full bg-transparent outline-none text-lg font-bold text-slate-900 placeholder:text-slate-300 truncate font-mono ml-1"
                    ...
                    {/* 2. TO */}
                    <div className="md:w-auto md:flex-[1.5] relative group p-4 border-b md:border-0 border-slate-100 md:hover:bg-slate-50 md:rounded-full transition-colors rounded-tr-2xl md:rounded-tr-none" ref={toRef}>
                        <label className="flex items-center gap-2 text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1.5 ml-1">
                    ...
                    {/* 3. DEPART */}
                    <div className="md:w-auto md:flex-1 relative group p-4 border-r border-b md:border-0 border-slate-100 md:hover:bg-slate-50 md:rounded-full transition-colors cursor-pointer" ref={departRef} onClick={() => setShowDepartCalendar(!showDepartCalendar)}>
                        <label className="flex items-center gap-2 text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1.5 ml-1">
                            <CalendarDays className="w-3.5 h-3.5" /> Depart
                        </label>
                        <div className={`text-lg font-bold truncate font-mono ml-1 ${flightForm.date ? "text-slate-900" : "text-slate-300"}`}>
                    ...
                    {/* 4. RETURN */}
                    <div className="md:w-auto md:flex-1 relative group p-4 border-b md:border-0 border-slate-100 md:hover:bg-slate-50 md:rounded-full transition-colors cursor-pointer"
                        ref={returnRef}
                    ...
                    {/* 5. TRAVELLERS */}
                    <div className="md:w-auto md:flex-1 relative group p-4 border-r md:border-0 border-slate-100 md:hover:bg-slate-50 md:rounded-full transition-colors cursor-pointer rounded-bl-2xl md:rounded-bl-none" ref={travellersRef} onClick={() => setShowTravellers(!showTravellers)}>
                        <label className="flex items-center gap-2 text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1.5 ml-1">
                    ...
                    {/* 6. SEARCH BUTTON */}
                    <div className="w-full md:w-auto p-3 col-span-1 rounded-br-2xl md:rounded-none">
                        <button
                            type="button"
                            onClick={handleContinue}
                            style={{ backgroundColor: '#0056D2' }}
                            className="w-full md:w-auto h-14 md:h-14 md:px-8 text-white font-bold text-lg shadow-lg hover:shadow-xl hover:scale-105 active:scale-95 transition-all duration-200 flex items-center justify-center gap-2 group rounded-xl md:rounded-full"
                        >
